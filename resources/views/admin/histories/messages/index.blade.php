<x-layouts.app title="Histórico de mensagens" breadcrumbs="Historicos / Mensagens">
    <section class="card">
        <form method="get" class="grid grid-3">
            ...
            <div><label>Até</label><input type="date" name="to" value="{{ request('to') }}"></div>
    ...
    <section class="card" style="margin-top:16px;">
        <div class="table-wrap"><table><thead><tr><th>Data</th><th>Lote</th><th>Posição</th><th>Contato</th><th>Telefone</th><th>Cidade</th><th>Mensagem</th><th>Status</th><th>Tentativas</th><th>Erro</th><th>Ações</th></tr></thead><tbody>
        @forelse($recipients as $recipient)
            <tr>
                ...
                <td>@can('histories.view_message_content')<span>{{ Str::limit($recipient->rendered_message, 80) }}</span>@else<span class="muted">Conteúdo protegido</span>@endcan</td>
        ...
        @empty
            <tr><td colspan="11">Nenhum histórico encontrado.</td></tr>
        @endforelse
        </tbody></table></div>
        {{ $recipients->links() }}
    </section>
