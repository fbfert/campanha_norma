...
<label style="display:flex;gap:8px;align-items:center;font-weight:400;margin-top:12px;">
    ...
    Avisar que a mensagem e automatica
</label>
<div style="margin-top:12px;"><label for="transparency_text">Texto de transparencia</label><textarea id="transparency_text" name="transparency_text" rows="2">{{ old('transparency_text', $flow->transparency_text) }}</textarea></div>
