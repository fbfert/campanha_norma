...
class Breadcrumbs
{
    ...
    private const MAP = [
        ...
        'Inicio / Limpeza' => ['dashboard', null],
        'Inicio / Limpeza / Participações' => ['dashboard', 'admin.cleanup.index', null],
        'Inicio / Limpeza / Lixeira' => ['dashboard', 'admin.cleanup.index', null],
        ...
        'Inicio / Pauta de resposta' => ['dashboard', null],
        'Inicio / Pauta de resposta / Dossie' => ['dashboard', 'admin.pauta.index', null],
