...
The system SHALL provide a dashboard with administrative foundation metrics, real contact metrics after Etapa 2, real WhatsApp connection status after Etapa 3, and message/batch operational metrics only when those future modules exist.
...
- **WHEN** a dashboard card refers to messages sent today, active batches, or send failures before those modules are implemented
