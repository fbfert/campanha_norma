<x-layouts.app title="Lotes" breadcrumbs="Inicio / Mensagens / Lotes">
    <section class="card">
        <form method="get" class="grid grid-3">
            ...
            <div class="actions"><button class="btn" type="submit"><x-icon name="search" size="16" />Filtrar</button><a class="btn ghost" href="{{ route('admin.message-batches.index') }}">Limpar</a>@can('message_batches.create')<a class="btn" href="{{ route('admin.message-batches.create') }}"><x-icon name="plus" size="16" />Novo lote</a>@endcan</div>
        </form>
    </section>
