<x-layouts.app title="Histórico do contato" breadcrumbs="Contatos / Historico de mensagens">
    <section class="card">
        <h2>{{ $contact->name }}</h2>
